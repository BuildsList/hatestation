...
/obj/item/weapon/storage/daki
	...
	desc = "A large pillow depicting a girl in a compromising position. It has as many dimensions to it as you do."
...
/obj/item/weapon/storage/daki/attack_self(mob/living/user)
	...
	if(!custom_name)
		...
		desc = "A large pillow depicting [custom_name] in a compromising position. It has as many dimensions to it as you do."
	else
